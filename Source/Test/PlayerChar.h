...
UCLASS()
class TEST_API APlayerChar : public ACharacter
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		UObjectiveWidget* objWidget; //sets ObjectiveUI to the widget

	UPROPERTY()
		float objectsBuilt; //float to track built objects

	UPROPERTY()
		float matsCollected; //float to track collected mats
